...
<p>
  ...
  <img src="https://img.shields.io/badge/local--first-%F0%9F%8C%B1-34d399" alt="Local first">
</p>
...
| 🛡️ Controlled execution | Structured argv only, no shell interpolation, access-mode allowlists, timeouts, output caps, and managed process lifecycle. |
...
| 🛠️ **Builder** | `coding` + `coding` | Desktop coding workflows with bounded edits and safe project checks. |
...
- **🎚️ Three access modes:** `review` is read-only; `coding` enables bounded edits
...
- **⏱️ Resource caps:** reads, output, request bodies, process lifetimes, search
...
### 🛠️ 3. Start the coding-agent profile
...
<sub>Made for calm, capable coding agents. Built with 🦀 and a little care.</sub>
